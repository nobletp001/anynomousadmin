        ...
        <>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
            {statCards.map((card) => (
              ...
              >
                <div className={`absolute top-0 right-0 w-20 h-20 rounded-full blur-xl transition-all duration-300 ${card.glowClass} group-hover:opacity-150`} />
                <div className="flex items-center justify-between mb-3">
                  <span className="text-zinc-500 text-[11px] font-semibold uppercase tracking-wider">{card.label}</span>
