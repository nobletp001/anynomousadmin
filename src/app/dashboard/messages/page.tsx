...
import {
  ...
  ChevronDown, ChevronUp, User, CreditCard, GitMerge,
} from 'lucide-react'
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 divide-y md:divide-y-0 md:divide-x divide-zinc-800">
            ...
            <div className="p-4 space-y-2">
              ...
              {msg.sender?.referredBy ? (
                <>
                  <InfoRow label="Username" value={<span className="text-emerald-400">@{msg.sender.referredBy.referrerUsername}</span>} />
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-zinc-400 text-sm mt-1">All anonymous messages — latest first. Click a row to inspect details.</p>
      </div>
                  ...
                  {data?.data.length ? data.data.map((msg) => (
                    <React.Fragment key={msg.id}>
                      ...
                      >
                        ...
                        <td className="px-6 py-4 text-zinc-500 text-xs whitespace-nowrap">{formatDate(msg.createdAt)}</td>
                      </tr>
