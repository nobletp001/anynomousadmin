...
export function useTaskState() {
  ...
  return {
    ...
    activeImagesList, setActiveImagesList,
    selectedIds, setSelectedIds,
    bulkRating, setBulkRating,
    bulkRejectReason, setBulkRejectReason,
    bulkMode, setBulkMode,
    showReportForm, setShowReportForm,
    reportDeductAmount, setReportDeductAmount,
    reportReason, setReportReason,
    rejectPos, setRejectPos,
    isDraggingReject, setIsDraggingReject,
    dragStartReject, setDragStartReject,
    detailsPos, setDetailsPos,
    isDraggingDetails, setIsDraggingDetails,
    dragStartDetails, setDragStartDetails,
  };
}
