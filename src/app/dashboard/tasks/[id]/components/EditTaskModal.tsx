      ...
      <div className="bg-zinc-900 border border-zinc-700/80 rounded-2xl shadow-2xl w-full max-w-2xl max-h-[90vh] flex flex-col overflow-hidden relative">
        ...
        <div className="p-6 overflow-y-auto flex-1 space-y-5">
            ...
            <div className="grid grid-cols-1 gap-3 text-xs mt-1.5">
              <div>
                ...
                <input
                  ...
                  value={task.title}
                  disabled
                  className="w-full bg-zinc-950/60 border border-zinc-805/80 rounded-lg px-3 py-2 text-zinc-500 cursor-not-allowed select-none"
                />
              </div>
              <div>
                ...
                <textarea
                  ...
                  disabled
                  rows={2}
                  className="w-full bg-zinc-950/60 border border-zinc-805/80 rounded-lg p-2 text-zinc-500 cursor-not-allowed select-none resize-none"
                />
              </div>
            </div>
          </div>
          ...
          <BasicDetails
            ...
            setEditImages={editState.setEditImages}
            uploadError={editState.uploadError}
            setUploadError={editState.setUploadError}
          />
          <Instructions
          ...
          <Config
            ...
            setEditTaskType={editState.setEditTaskType}
            editTargetPlatform={editState.editTargetPlatform}
            setEditTargetPlatform={editState.setEditTargetPlatform}
            editProofType={editState.editProofType}
            setEditProofType={editState.setEditProofType}
            editAcceptText={editState.editAcceptText}
            setEditAcceptText={editState.setEditAcceptText}
            editTextLabel={editState.editTextLabel}
            setEditTextLabel={editState.setEditTextLabel}
            editAcceptNumber={editState.editAcceptNumber}
            setEditAcceptNumber={editState.setEditAcceptNumber}
            editNumberLabel={editState.editNumberLabel}
            ...
            setEditAdminContact={editState.setEditAdminContact}
            editPrompts={editState.editPrompts}
            setEditPrompts={editState.setEditPrompts}
            editRequirePromptSelection={editState.editRequirePromptSelection}
          ...
          <Targeting
            ...
            setEditEnableTargeting={editState.setEditEnableTargeting}
            editAudience={editState.editAudience}
            setEditAudience={editState.setEditAudience}
          />
          <RewardTimeline
            taskApprovedCount={task.approvedCount}
            editNumberOfUsers={editState.editNumberOfUsers}
            ...
            setEditTimeline={editState.setEditTimeline}
