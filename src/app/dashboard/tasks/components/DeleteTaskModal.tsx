...
export function DeleteTaskModal({ title, isPending, onClose, onConfirm }: DeleteTaskModalProps) {
  return (
      ...
      <div className="w-full max-w-sm bg-zinc-900 border border-zinc-800 rounded-2xl shadow-2xl p-6 space-y-5 animate-fade-up">
        ...
        <div className="space-y-1.5">
          ...
          <p className="text-sm text-zinc-400 leading-relaxed">
            Are you sure you want to delete <span className="font-semibold text-zinc-200">&ldquo;{title}&rdquo;</span>? This will also
