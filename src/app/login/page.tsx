      ...
      >
        <div className="backdrop-blur-md bg-zinc-900/60 border border-zinc-800/80 rounded-2xl p-8 shadow-2xl">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-5" noValidate>
            ...
            <Button type="submit" variant="primary" size="lg" fullWidth isLoading={isBusy} className="mt-2">
              {isBusy ? "Authenticating…" : "Sign In"}
            </Button>
          </form>
        </div>

        <p className="text-center text-xs text-zinc-600 mt-5">Restricted access — admin credentials required</p>
      </motion.div>
    </main>
  );
}
